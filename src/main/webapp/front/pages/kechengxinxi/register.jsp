      ...
      <div class="form-inner">
          ...
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="kechengmingcheng" name="kechengmingcheng" placeholder="请输入课程名称" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="keshi" name="keshi" placeholder="请输入课时" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
