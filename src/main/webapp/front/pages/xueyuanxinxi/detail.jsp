				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>学院性质：</span>
							<span class="desc">
								{{detail.xueyuanxingzhi}}
							</span>
						</div>
																								<div class="detail-item">
							<span>学院类型：</span>
							<span class="desc">
								{{detail.xueyuanleixing}}
							</span>
						</div>
																								<div class="detail-item">
							<span>招生电话：</span>
							<span class="desc">
								{{detail.zhaoshengdianhua}}
							</span>
						</div>
																								<div class="detail-item">
							<span>学院邮箱：</span>
							<span class="desc">
								{{detail.xueyuanyouxiang}}
							</span>
						</div>
																								<div class="detail-item">
							<span>学院网址：</span>
							<span class="desc">
								{{detail.xueyuanwangzhi}}
							</span>
						</div>
																								<div class="detail-item">
							<span>学院地址：</span>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div class="layui-tab-content">
								...
								<div v-html="detail.xueyuanjianjie"></div>
							</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`xueyuanxinxi`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.xueyuanmingcheng;
																																																																																																																								// 轮播图片
