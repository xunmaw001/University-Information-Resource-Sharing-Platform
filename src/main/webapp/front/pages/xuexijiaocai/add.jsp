			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.jiaocaibianhao" type="text" name="jiaocaibianhao" id="jiaocaibianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">教材名称：</label>
						<div class="layui-input-block">
							<input v-model="detail.jiaocaimingcheng" type="text" name="jiaocaimingcheng" id="jiaocaimingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">教材类型：</label>
						<div class="layui-input-block">
							<input v-model="detail.jiaocaileixing" type="text" name="jiaocaileixing" id="jiaocaileixing" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.neirongjieshao" type="text" name="neirongjieshao" id="neirongjieshao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.jiaoshigonghao" type="text" name="jiaoshigonghao" id="jiaoshigonghao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.clicknum" type="text" name="clicknum" id="clicknum" autocomplete="off" class="layui-input">
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            <div class="layui-form-item" pane>
						<label class="layui-form-label">教材简介：</label>
						<div class="layui-input-block">
							<textarea name="jiaocaijianjie" id="jiaocaijianjie">请输入教材简介</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var jiaocaijianjie = tinymce.get('#jiaocaijianjie').getContent()
					data.jiaocaijianjie = jiaocaijianjie;
					...
					// 提交数据
					http.requestJson('xuexijiaocai' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
