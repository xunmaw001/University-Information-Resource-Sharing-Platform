				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>教材编号：</span>
							<span class="desc">
								{{detail.jiaocaibianhao}}
							</span>
						</div>
																																										<div class="detail-item">
							<span>教材类型：</span>
							<span class="desc">
								{{detail.jiaocaileixing}}
							</span>
						</div>
																																																												<div class="detail-item">
							<span>内容介绍：</span>
							<span class="desc">
								{{detail.neirongjieshao}}
							</span>
						</div>
																								<div class="detail-item">
							<span>上传时间：</span>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div class="layui-tab-content">
								...
								<div v-html="detail.jiaocaijianjie"></div>
							</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`xuexijiaocai`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																									vue.title = vue.detail.jiaocaimingcheng;
																														// 轮播图片
