			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.bianhao" type="text" name="bianhao" id="bianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">名称：</label>
						<div class="layui-input-block">
							<input v-model="detail.mingcheng" type="text" name="mingcheng" id="mingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-inline" style="line-height: 50px;">
							<input type="hidden" :value="detail.ziliao" id="ziliao" name="ziliao" />
                            <button type="button" class="layui-btn btn-theme" id="ziliaoUpload">
								<i class="layui-icon">&#xe67c;</i>上传资料
							</button>
							<a download="资料" :href="detail.ziliao">点击下载资料</a>
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
				...
				var tupianUpload = upload.render({
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																												                ...
																												                var ziliaoUpload = upload.render({
					//绑定元素
					elem: '#ziliaoUpload',
					//上传接口
					url: http.baseurl + 'file/upload',
					...
					// 上传成功
						...
						if (res.code == 0) {
							...
							var url = http.baseurl + 'upload/' + res.file;
							jquery('#ziliao').val(url);
                            vue.detail.ziliao = url;
						} else {
							layer.msg(res.msg, {
								time: 2000,
								icon: 5
