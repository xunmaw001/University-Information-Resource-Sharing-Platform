...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('keshi')">课时<i id="keshiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var kechengneirongCell  = document.createElement('td');

						  if(item.kechengneirong != null && item.kechengneirong != "" && item.kechengneirong.length >= 11){
			  	kechengneirongCell.innerHTML = item.kechengneirong.substring(0, 10) + "..."; 
			  }else{
			  	kechengneirongCell.innerHTML = item.kechengneirong;
			  }


			row.appendChild(kechengneirongCell);
			var kechengrenwuCell  = document.createElement('td');

						  if(item.kechengrenwu != null && item.kechengrenwu != "" && item.kechengrenwu.length >= 11){
			  	kechengrenwuCell.innerHTML = item.kechengrenwu.substring(0, 10) + "..."; 
			  }else{
			  	kechengrenwuCell.innerHTML = item.kechengrenwu;
			  }


			row.appendChild(kechengrenwuCell);
