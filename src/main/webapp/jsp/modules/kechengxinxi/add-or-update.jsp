...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>课时</label>
										<input id="keshi" name="keshi" class="form-control" placeholder="课时">
									</div>
									<div class="form-group col-md-6">
										<label>开始时间</label>
									...
									<div class="form-group col-md-6">
										<label>课程内容</label>
										<textarea name="kechengneirong" class="form-control" id="kechengneirong" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>课程任务</label>
										<textarea name="kechengrenwu" class="form-control" id="kechengrenwu" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>封面</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#kechengneirong").val(ruleForm.kechengneirong);
			$("#kechengrenwu").val(ruleForm.kechengrenwu);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.kechengneirong != null && res.data.kechengneirong != ''){

					$("#kechengneirong").val(res.data.kechengneirong);
					}
					if(res.data != null && res.data != '' && res.data.kechengrenwu != null && res.data.kechengrenwu != ''){

					$("#kechengrenwu").val(res.data.kechengrenwu);
					}
