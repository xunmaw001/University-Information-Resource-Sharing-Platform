	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input type="text" name="jiaoshigonghao" placeholder="教师工号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="zhicheng" placeholder="职称" class="form-control-i">
							</div>
																																			<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				$.ajax({ 
					type: "POST",
					url: baseUrl + "jiaoshixinxi/register",
