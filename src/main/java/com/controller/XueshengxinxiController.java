...
public class XueshengxinxiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XueshengxinxiEntity user = xueshengxinxiService.selectOne(new EntityWrapper<XueshengxinxiEntity>().eq("zhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"xueshengxinxi",  "学生信息" );
    ...
    public R register(@RequestBody XueshengxinxiEntity xueshengxinxi){
    	...
    	XueshengxinxiEntity user = xueshengxinxiService.selectOne(new EntityWrapper<XueshengxinxiEntity>().eq("zhanghao", xueshengxinxi.getZhanghao()));
		if(user!=null) {
