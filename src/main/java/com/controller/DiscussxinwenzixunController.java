...
public class DiscussxinwenzixunController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussxinwenzixunEntity discussxinwenzixun, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussxinwenzixunEntity discussxinwenzixun, HttpServletRequest request){
        EntityWrapper<DiscussxinwenzixunEntity> ew = new EntityWrapper<DiscussxinwenzixunEntity>();
    	PageUtils page = discussxinwenzixunService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussxinwenzixun), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
