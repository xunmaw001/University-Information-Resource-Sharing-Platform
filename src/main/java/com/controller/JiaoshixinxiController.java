...
public class JiaoshixinxiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiaoshixinxiEntity user = jiaoshixinxiService.selectOne(new EntityWrapper<JiaoshixinxiEntity>().eq("jiaoshigonghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"jiaoshixinxi",  "教师信息" );
    ...
    public R register(@RequestBody JiaoshixinxiEntity jiaoshixinxi){
    	...
    	JiaoshixinxiEntity user = jiaoshixinxiService.selectOne(new EntityWrapper<JiaoshixinxiEntity>().eq("jiaoshigonghao", jiaoshixinxi.getJiaoshigonghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JiaoshixinxiEntity jiaoshixinxi, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JiaoshixinxiEntity jiaoshixinxi, HttpServletRequest request){
        EntityWrapper<JiaoshixinxiEntity> ew = new EntityWrapper<JiaoshixinxiEntity>();
    	PageUtils page = jiaoshixinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jiaoshixinxi), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
